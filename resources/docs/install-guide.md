...
cd claude-obsidian
bash _system/bin/setup-vault.sh
```
...
| Excalidraw not loading | Run `bash _system/bin/setup-vault.sh` to download `main.js` (8MB, not in git) |
