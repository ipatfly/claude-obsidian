...
```
vault/
├── _raw/              # crawl exports, analytics, scraped pages, GSC data
├── wiki/
...
```
vault/
├── _raw/              # README, git log exports, code dumps, issue exports
├── wiki/
...
```
vault/
├── _raw/              # meeting transcripts, Slack exports, docs, emails
├── wiki/
...
```
vault/
├── _raw/              # journal entries, articles, podcast notes, voice transcripts
├── wiki/
...
```
vault/
├── _raw/              # PDFs, web clips, data files, raw notes
├── wiki/
