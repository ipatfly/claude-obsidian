...
### Save to _raw/
```bash
defuddle https://example.com/article > _raw/articles/article-slug-$(date +%Y-%m-%d).md
```
...
{ echo "---"; echo "source_url: https://example.com/article"; echo "fetched: $(date +%Y-%m-%d)"; echo "---"; echo ""; defuddle https://example.com/article; } > _raw/articles/$SLUG.md
```
...
2. Then: `ingest _raw/articles/[slug].md`
