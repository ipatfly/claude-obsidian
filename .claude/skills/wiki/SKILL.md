...
Dot-prefixed folders (`_raw/`) are hidden in Obsidian's file explorer and graph view. Use this for source documents.
...
- Archive: move cold sources to .archive/ to keep _raw/ clean
```
